...
contract StellarToken {
    ...
    string public symbol = "STELLAR";
    uint256 public totalSupply = 1000000000000000000000; // 1 millon de tokens
    ...
    // Transferencia de token de un usuario
    ...
    // Aprobacion de una cantidad para ser gastada por in operador
